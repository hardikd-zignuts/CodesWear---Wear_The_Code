...
const PorductDetail = ({ productData }) => {
    const { id, price, title, thumbnail, description } = productData
    ...
    const checkStatus = async () => {
        ...
        if (resJson.includes(parseInt(pin))) {
            toast.success("Yes Product is deliverable at this pincode")
        } else {
            toast.error("Sorry!! We could not deliver at this pincode")
        }
    }
            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap ">
                        <Image width={400} height={400} alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded shadow-xl" src={thumbnail} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <span className="text-gray-600 ml-3">45 Reviews</span>
                                </span>
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => dispatch(addToCart({
                                    ...
                                    quantity: 1,
                                    basePrice: price
                                }))} className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">Add to cart</button>
                            </div>
                            <div className="flex justify-between my-2">
                                ...
                                <button id='check-btn' onClick={checkStatus} className=" text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">Check Availblity</button>
                            </div>
                        </div>
                    </div>
                </div>
